...
# I read the file path in csv so it is easier to work with. When open the txt file,
# each values are separated by ";" so sep = ";". stringsAsFactors = FALSE, to pevent 
# automatic character conversion.

file_path <- "Downloads/household_power_consumption.txt"
powerConsum <- read.csv(file_path, sep = ";", stringsAsFactors = FALSE)
